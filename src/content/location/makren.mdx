...
The [Citizen's Union](lore:citizens-unions) of Makren, and therefore the
enclave itself, is almost entirely controlled by the Makren lineage. This seems
to work well enough; despite the relative lack of democratic input from
citizens, the Makren lineage is relatively well liked and respected, and does a
satisfactory job of administering the enclave, and provides popular public
services and works such as [the later tree](lore:the-later-tree).
