...
De can't speak it, can't even gesture it, without a mouth to speak or body to
pose with, but de tries to hold the attitude that de would have if de _was_
speaking it.
...
pressure underneath dir feet -- can feel dir feet! -- and is startled to
realise that de is standing opposite the something. The blob of Tamryn slips,
