...
structure within visible range. Bridgestones are harvested here for raw
materials where they have been loosened by the damage.
...
Under the street, a [system of sewer and service tunnels](lore:the-underneath)
runs the length of the bridge, containing it's own unique ecosystem of weird
and dangerous [fauna](tag:fauna).
