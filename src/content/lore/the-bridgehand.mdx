...
The Bridgehand earned it's name for the shape that it makes around the top of
the 11-firthan pillar. From a distance it appears overwhelming purple, but any
colour can be found somewhere inside. For miles, the bridge is dominated by a
wild forest of tendrils and mushrooms, sometimes taller than some of the
buildings in Longbridge. These structures grow tallest near the edges of the
bridge, leaving the central street relatively passable, until you get too deep
into the forest and the thicket becomes impossible to navigate.
...
<include src="lore:products-of-the-bridgehand" with-heading all />
<include src="lore:the-cult-of-the-hand" with-heading all />
