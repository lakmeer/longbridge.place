...
[coupling handle](lore:coupling-handles) or
[stable-machine](lore:stable-machines).
...
[echoes](lore:attrapulsion#sensing-and-echoes) that can be sensed by a remote pulser.
...
##### Feedback
Exploiting the coupling between a handle and it’s user to cause overexertion in
