...
It was also around this time that simple kinesis effects via deliberate
[mental coupling](lore:coupling-handles) started to become possible. Modified
forms of the Blyn ring could be used to hold small projectiles, and triggered
to collapse the stable effect on command via a coupling handle. It became clear
...
- [Shuddering](lore:attrapulsive-effects#shuddering) attacks between rival guilds of Pulser’s Clave
- Stimulating [lumin gas](lore:lumin) for street lamps

### Recent Advancements and Current Research

- [Storm shields](lore:storm-shields)
- [Raincatchers](lore:raincatchers)
- [Rememberers](lore:rememberer)
