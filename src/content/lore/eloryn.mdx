...
tags:
  ...
  - librarians
  - deities
  - emperical-sprituality
---

Eloryn is a [deitic hyperorganism](lore:empirical-sprirituality) and the
...
efforts of dir [Librarians](location:library-of-eloryn#librarians).

As an anthropomorphised personality, Eloryn is considered to be nymi, embodying
the disciplined and monastic ideals ascribed to nymi citizens as a class. As
such, de is patient, wise, impartial and non-judgemental. 'Eloryn' is an
archaic but still recognisably nymi-coded name.
